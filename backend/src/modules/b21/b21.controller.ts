...
import { B21Service } from './b21.service.js';
import { ApiResponse } from '../../shared/types/index.js';

export class B21Controller {
  constructor(private service: B21Service = new B21Service()) {}
  ...
  public evaluate = async (req: Request, res: Response<ApiResponse>, next: NextFunction): Promise<void> => {
    try {
      ...
      const result = await this.service.evaluateCompleteness(req.body, userId);
      res.status(200).json({
        success: true,
        data: result,
        meta: {
